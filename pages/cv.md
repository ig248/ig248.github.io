...
<a href="{{ site.url }}/files/CV_Igor_Gotlibovych_PhD.pdf" class="social-icons" title="Printer friendly format"><i class="fa fa-print"></i></a>
</span>

<!-- Alternaetly, user html5 embed tag -->
<iframe src="{{ site.url }}/files/CV_Igor_Gotlibovych_PhD.pdf" width="100%" style="height: 100vh;"></iframe>
